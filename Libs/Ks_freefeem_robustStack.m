...
%
%
function [Solucions] =  Ks_freefeem_robustStack(KsOptions)
syms x t y;
%escribiendo el archivo de freefem
Wrtitefreem_robust_stack(KsOptions.inicial_cond,KsOptions.Objetive_func);

command = char(strcat('FreeFem++ -nw -v 0 Ks_stackelberg/Stak_Robust_Temman_linear_CG.edp', {' '},...
                      ...
                      '-LminControlLider', {' '} ,num2str(KsOptions.LiderDom(1),16),{' '},...
                      '-LmaxControlLider', {' '} ,num2str(KsOptions.LiderDom(2),16),{' '},...
                      ...
                      '-beta1', {' '} ,num2str(KsOptions.beta1,16),{' '},...
                      '-beta2', {' '} ,num2str(KsOptions.beta2,16),{' '},...
...
identifier = ['mu_',num2str(KsOptions.mu,16),...
			  ...
			  '_beta1_',num2str(KsOptions.beta1,16),...
			  '_beta2_',num2str(KsOptions.beta2,16)];
dirsave = ['Ks_stackelberg/savefile/Control_robust_GD_nonlinar/',identifier];
